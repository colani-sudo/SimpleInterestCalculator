 ...
 *  Both the interest earned and the investment after
 *  one year will be printed.
 */
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.printf("The interest earned is $%.2f" +
                " The value of the investment after one year is $%.2f", interest, principal);
    }
}